...
class Login_Model extends Model{
	...
	switch($_POST['type']){
	    case "0":
		$sth = $this->dbh->prepare('SELECT password FROM studenten_extern WHERE studentnummer = :studentnummer');
		$sth->execute(array(
